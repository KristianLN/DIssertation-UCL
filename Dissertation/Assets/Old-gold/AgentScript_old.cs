...
public class AgentScript_old : Agent
{
    ...
    private void Start()
    {
      ...
      Debug.Log(TargetSpawns[0].position);
    }
    ...
    private void OnCollisionEnter(Collision collision)
    {
      ...
      if (collision.collider.CompareTag("Goal"))
      {
        ...
        //Debug.Log(rand);
        //Debug.Log(TargetSpawns.Length);
        Rbb = Target.GetComponent<Rigidbody>();
        Rbb.MovePosition(TargetSpawns[rand].position);
        Done();
        //counter += 1;
        //Debug.Log(counter);
        //target.position = TargetSpawns[rand].position;//target.transform.position
        //Debug.Log(TargetSpawns[rand]);
        //Debug.Log(TargetSpawns[rand].position);
        //Debug.Log(TargetSpawns[rand].scale);
        //Debug.Log(TargetSpawns[rand].rotation);
      }
    }
