...
public class DetectCollision_4_1 : MonoBehaviour
{
  ...
  public void Start()
  {
    ...
    firstBrain = this.GetComponent<AgentScript_4_1_clean>().firstBrain;
    secondBrain = this.GetComponent<AgentScript_4_1_clean>().secondBrain;
  }
