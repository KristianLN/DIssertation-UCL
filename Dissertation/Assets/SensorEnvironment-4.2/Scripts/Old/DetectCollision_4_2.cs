...
public class DetectCollision_4_2 : MonoBehaviour
{
  ...
  public void Start()
  {
    ...
    firstBrain = this.GetComponent<AgentScript_4_2_clean>().firstBrain;
    secondBrain = this.GetComponent<AgentScript_4_2_clean>().secondBrain;
  }
